...
import { AddAccountRepositorySpy, CheckAccounByEmailRepositorySpy } from '@/tests/data/mocks/mock-db-account'
...
const makeSut = (): SutType => {
  const checkAccounByEmailRepositoryStub = new CheckAccounByEmailRepositorySpy()
